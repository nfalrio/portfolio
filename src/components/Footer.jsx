  ...
  return (
    <footer className="footer">
      <div className="container footer__inner">
        <div className="footer__copy text-secondary" style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
          <span>© {new Date().getFullYear()} Muhammad Naufal Rio Ramadhan</span>
          <span style={{ fontSize: '0.8rem', opacity: 0.8 }}>Built with React, Tailwind, Framer Motion & Three.js</span>
        </div>
