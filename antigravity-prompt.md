...
- CSS murni dengan **design system custom** di `src/styles/index.css`
  (bernama "Mathematical Precision" di komentar file) — JANGAN diganti ke
  Tailwind/shadcn.
...
4. Jangan pindah dari Vite ke Next.js. Jangan tambah Tailwind/shadcn.
